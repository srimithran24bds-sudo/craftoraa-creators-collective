...
const categoryData: Record<string, {
  ...
  gifts: {
    ...
    image: categoryGifts,
    products: [
      { name: "Customized Photo Albums", price: 799, seller: "PaperLove", rating: 4.9, description: "Handmade photo albums with personalized covers and layouts.", slug: "photo-albums" },
      { name: "Scrapbooks", price: 899, seller: "PaperLove", rating: 4.8, description: "Creative handmade scrapbooks to preserve precious memories.", slug: "scrapbooks" },
      { name: "Handmade Greeting Cards", price: 149, seller: "CardCraft", rating: 4.6, description: "Beautiful handcrafted greeting cards for every occasion.", slug: "greeting-cards" },
      { name: "Explosion Boxes", price: 599, seller: "WrapJoy", rating: 4.9, description: "Surprise explosion boxes with photos, messages & treats.", slug: "explosion-boxes" },
      { name: "Photo Frames", price: 449, seller: "FrameArt", rating: 4.7, description: "Decorated wooden & fabric photo frames with custom designs.", slug: "photo-frames" },
      { name: "Customized Mugs", price: 349, seller: "PrintHouse", rating: 4.5, description: "Custom mugs with names, quotes, photos or artwork.", slug: "customized-mugs" },
      { name: "Customized Water Bottles", price: 499, seller: "PrintHouse", rating: 4.6, description: "Personalized water bottles with custom prints and names.", slug: "water-bottles" },
      { name: "Customized T-Shirts", price: 599, seller: "PrintHouse", rating: 4.5, description: "Custom printed t-shirts with your own designs and text.", slug: "custom-tshirts" },
      { name: "Personalized Keychains", price: 199, seller: "TinyGifts", rating: 4.7, description: "Custom name and photo keychains in metal, wood & acrylic.", slug: "personalized-keychains" },
      { name: "Name Bracelets", price: 299, seller: "TinyGifts", rating: 4.6, description: "Handcrafted bracelets with custom name beads.", slug: "name-bracelets" },
      { name: "Friendship Bands", price: 149, seller: "TinyGifts", rating: 4.5, description: "Colorful handmade friendship bands with custom patterns.", slug: "friendship-bands" },
      { name: "Handmade Journals", price: 499, seller: "PaperLove", rating: 4.8, description: "Leather-bound and fabric-covered handmade journals.", slug: "handmade-journals" },
      { name: "Personalized Notebooks", price: 349, seller: "PaperLove", rating: 4.6, description: "Custom cover notebooks with name and artwork.", slug: "personalized-notebooks" },
      { name: "Mini Gift Hampers", price: 699, seller: "WrapJoy", rating: 4.9, description: "Curated mini hampers with handmade goodies & treats.", slug: "mini-hampers" },
      { name: "Chocolate Gift Boxes", price: 549, seller: "WrapJoy", rating: 4.7, description: "Beautifully packaged artisan chocolate gift boxes.", slug: "chocolate-boxes" },
      { name: "Customized Calendars", price: 399, seller: "PrintHouse", rating: 4.5, description: "Photo calendars with personalized dates and messages.", slug: "custom-calendars" },
      { name: "Photo Cushions", price: 649, seller: "StitchGift", rating: 4.7, description: "Soft cushions printed with your favorite photos.", slug: "photo-cushions" },
      { name: "Memory Boxes", price: 799, seller: "WrapJoy", rating: 4.8, description: "Decorative keepsake boxes for storing precious memories.", slug: "memory-boxes" },
      { name: "Handmade Toy Gifts", price: 449, seller: "ToyArt", rating: 4.6, description: "Safe handmade plush toys and wooden toy gifts for kids.", slug: "toy-gifts" },
      { name: "Customized Stickers", price: 99, seller: "CardCraft", rating: 4.4, description: "Custom vinyl and paper stickers with fun designs.", slug: "custom-stickers" },
      { name: "Personalized Phone Cases", price: 499, seller: "PrintHouse", rating: 4.6, description: "Custom phone cases with photos, artwork or names.", slug: "phone-cases" },
      { name: "Wedding Return Gifts", price: 299, seller: "WrapJoy", rating: 4.8, description: "Elegant handmade return gifts for wedding guests.", slug: "wedding-return-gifts" },
      { name: "Birthday Gift Kits", price: 899, seller: "WrapJoy", rating: 4.9, description: "Complete birthday surprise kits with cards, treats & gifts.", slug: "birthday-kits" },
      { name: "Anniversary Gift Sets", price: 1299, seller: "WrapJoy", rating: 4.9, description: "Romantic curated anniversary gift sets for couples.", slug: "anniversary-sets" },
    ],
  },
};
